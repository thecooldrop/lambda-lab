...
// NOTE: EVERY TIME YOU REMOVE A COMMENT FROM BLOCK OF RESOURCES PLEASE CHANGE THE NAME FIELD OF THE RESOURCE TO
//       SOME RANDOM STRING TO AVOID CONFLICTS WITH RESOURCES FROM OTHER USERS IN THE AWS ACCOUNT.
